...
namespace SharpClient.UI.Menus
{
    ...
    [Designer(typeof(SharpClient.UI.Menus.MenuControlDesigner))]
    public class MenuControl : ContainerControl, IMessageFilter
    {
        ...
        static MenuControl()
        {
            ...
            _menuImages = ResourceHelper.LoadBitmapStrip(Type.GetType("SharpClient.UI.Menus.MenuControl"),
                                                         "SharpClient.UI.Resources.ImagesMenuControl.bmp",
