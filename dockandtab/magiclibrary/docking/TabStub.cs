...
namespace SharpClient.UI.Docking
{
    ...
    public class TabStub : UserControl
    {
		private class DrawTab
		{
            ...
            protected SharpClient.UI.Controls.TabPage _tabPage;
			...
			public SharpClient.UI.Controls.TabPage TabPage  { get { return _tabPage; } }
		...
		protected void ResizeControl()
		{
			...
			{
				foreach(SharpClient.UI.Controls.TabPage page in _tabPages)
				{
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
			...
			using(Pen borderPen = new Pen(ControlPaint.LightLight(this.ForeColor)))
			{
				...
				foreach(DrawTab dt in _drawTabs)
				{
					...
					SharpClient.UI.Controls.TabPage page = dt.TabPage;
