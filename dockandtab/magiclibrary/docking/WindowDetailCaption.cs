...
//                this.Context += contextHandler;	
    ...
    public class WindowDetailCaptionPlain : WindowDetailCaption
    {
        ...
        static WindowDetailCaptionPlain()
        {
            ...
            _images = ResourceHelper.LoadBitmapStrip(Type.GetType("SharpClient.UI.Docking.WindowDetailCaptionPlain"),
                                                     "SharpClient.UI.Resources.SCUIImgPlain.bmp",
    ...
    public class WindowDetailCaptionIDE : WindowDetailCaption
    {
        ...
        {
            // Create a strip of images by loading an embedded bitmap resource
            _images = ResourceHelper.LoadBitmapStrip(Type.GetType("SharpClient.UI.Docking.WindowDetailCaptionIDE"),
                                                     "SharpClient.UI.Resources.SCUIImgIDE.bmp",
                                                     new Size(_imageWidth, _imageHeight),
                                                     new Point(0,0));
        }
        ...
        public WindowDetailCaptionIDE(DockingManager manager, 
                                      EventHandler closeHandler, 
                                      EventHandler restoreHandler, 
                                      EventHandler invertAutoHideHandler)//,                                     ContextHandler contextHandler)			
            : base(manager, 
                   new Size(_fixedLength, _fixedLength), 
                   closeHandler, 
                   restoreHandler, 
