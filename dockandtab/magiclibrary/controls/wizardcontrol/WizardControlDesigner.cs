...
namespace SharpClient.UI.Controls
{
    public class WizardControlDesigner :  System.Windows.Forms.Design.ParentControlDesigner
    {
        ...
        public override ICollection AssociatedComponents
        {
            get 
            {
                if (base.Control is SharpClient.UI.Controls.WizardControl)
                    return ((SharpClient.UI.Controls.WizardControl)base.Control).WizardPages;
                else
        ...
        protected override void WndProc(ref Message msg)
        {
            ...
            {
                SharpClient.UI.Controls.WizardControl wizardControl = this.SelectionService.PrimarySelection as SharpClient.UI.Controls.WizardControl;

                // Check we have a valid object reference
                if (wizardControl != null)
                {
                    SharpClient.UI.Controls.TabControl tabControl = wizardControl.TabControl;
