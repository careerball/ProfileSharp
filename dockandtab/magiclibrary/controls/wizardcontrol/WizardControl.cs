...
namespace SharpClient.UI.Controls
{
    ...
    public class WizardControl : UserControl
	{
        ...
        protected SharpClient.UI.Controls.TabControl _tabControl;
        ...
        static WizardControl()
        {
            ...
            _standardPicture = ResourceHelper.LoadBitmap(Type.GetType("SharpClient.UI.Controls.WizardControl"),
                                                         "SharpClient.UI.Resources.WizardPicture.bmp");
        }
