...
namespace SharpClient.UI.Controls
{
    ...
    [Designer(typeof(SharpClient.UI.Controls.TabControlDesigner))]
...
//        protected PopupMenu _contextMenu;       // Context menu to show on right mouse up
        ...
        static TabControl()
        {
            ...
            _internalImages = ResourceHelper.LoadBitmapStrip(Type.GetType("SharpClient.UI.Controls.TabControl"),
                                                             "SharpClient.UI.Resources.SCUIImgTabControl.bmp",
...
//        }
        ...
        protected virtual void DefineBackColor(Color newColor)
        {
            ...
            _backLight = Color.FromKnownColor(KnownColor.ControlLight)  ;//ControlPaint.Light(newColor);
            _backLightLight =Color.Black ;// Color.FromKnownColor(KnownColor.ControlLightLight);
            _backDark =Color.FromKnownColor(KnownColor.ControlDark) ;//ControlPaint.Dark(newColor);
            _backDarkDark = Color.Black;//Color.FromKnownColor(KnownColor.ControlDarkDark);//ControlPaint.DarkDark(newColor);

            //_backIDE = ColorHelper.TabBackgroundFromBaseColor(newColor);
			_backIDE = ColorHelper.TabBackgroundFromBaseColor(Color.FromKnownColor(KnownColor.ControlDarkDark ));
