...
namespace SharpClient.UI.Controls
{
	...
	public class TargetManager
	{
	    ...
	    {
            _validCursor = ResourceHelper.LoadCursor(Type.GetType("SharpClient.UI.Controls.TabbedGroups"),
                                                                  "SharpClient.UI.Resources.SCUIValidTab.cur");

            _invalidCursor = ResourceHelper.LoadCursor(Type.GetType("SharpClient.UI.Controls.TabbedGroups"),
                                                                    "SharpClient.UI.Resources.SCUIInvalidTab.cur");
        }
