...
namespace SharpClient.UI.Controls
{
    ...
    public class TabbedGroups : UserControl, ISupportInitialize, IMessageFilter
	{
        ...
        public virtual void OnTabControlCreated(Controls.TabControl tc)
        {
            ...
            tc.Appearance = SharpClient.UI.Controls.TabControl.VisualAppearance.MultiDocument;
            tc.BoldSelectedPage = false;
            ...
            switch(_displayTabMode)
            {
                case TabbedGroups.DisplayTabModes.ShowAll:
                    tc.HideTabsMode = SharpClient.UI.Controls.TabControl.HideTabsModes.ShowAlways;
                    break;
                case TabbedGroups.DisplayTabModes.HideAll:
                    tc.HideTabsMode = SharpClient.UI.Controls.TabControl.HideTabsModes.HideAlways;
                    break;
            }
...
//            xmlOut.WriteComment(" SharpClient.UI, The User Interface library for .NET (www.SharpClientUi.com) ");
