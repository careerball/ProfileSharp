...
namespace PSUI {
	...
	/// </summary>
	/// <remarks>
	/// <c>ColorPair</c> uses a customized UITypeEditor (<see cref="PSUI.Helpers.ColorPairEditor"/>)
	/// for better IDE integration, as well as a custom <see cref="TypeConverter"/> 
	/// (<see cref="PSUI.Helpers.ColorPairConverter"/>)
	/// <para>This class is <see cref="SerializableAttribute"/> but does not implement 
	/// <see cref="System.Runtime.Serialization.ISerializable"/></para>
	/// </remarks>
#if DEBUG
	[Editor(typeof(PSUI.Helpers.ColorPairEditor), typeof(System.Drawing.Design.UITypeEditor))]
	[TypeConverter(typeof(PSUI.Helpers.ColorPairConverter))] 
#endif
	[Serializable]
