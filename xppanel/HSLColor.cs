...
namespace PSUI {
	...
	/// by <see cref="PSPanel"/> or any other Control/Component in the name space.
	/// <para>
	...
	/// <see cref="TypeConverter"/>. See <see cref="PSUI.Helpers.HSLColorEditor"/>
	/// and <see cref="PSUI.Helpers.HSLColorConverter"/> respectively.
	/// </para>
	...
	[Serializable]
#if DEBUG
	[Editor(typeof(PSUI.Helpers.HSLColorEditor), typeof(System.Drawing.Design.UITypeEditor))]
	[TypeConverter(typeof(PSUI.Helpers.HSLColorConverter))] 
#endif
