...
namespace PSUI {
	...
	/// <see cref="PSUI.Helpers.GradientColorEditor"/> and 
	/// <see cref="PSUI.Helpers.GradientColorConverter"/> respectively.
	...
	/// </remarks>
#if DEBUG
	[Editor(typeof(PSUI.Helpers.GradientColorEditor), typeof(System.Drawing.Design.UITypeEditor))]
	[TypeConverter(typeof(PSUI.Helpers.GradientColorConverter))] 
#endif
	[Serializable]
