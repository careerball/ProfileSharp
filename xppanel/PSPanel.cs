...
namespace PSUI {
	#region PSPanel enumerations
	/// <summary>
	/// Enumeration describing the panel state
	/// </summary>
	/// <remarks>
	/// The panel can be in an inbetween state. <see cref="PSPanelDrawState"/>
	/// </remarks>
	public enum PSPanelState {
		/// <summary>
		/// The <c>PSPanel</c> is expanded
		/// </summary>
		Expanded,

		/// <summary>
		/// The <c>PSPanel</c> is collapsed
		/// </summary>
		Collapsed
	}
	...
	/// regarding the <see cref="PSPanelState"/>
	/// </summary>
	public enum PSPanelDrawState {
		/// <summary>
		/// <c>PSPanel</c> is not actively changing
		/// </summary>
		Normal,

		/// <summary>
		/// <c>PSPanel</c> is actively expanding
		/// </summary>
		Expanding,

		/// <summary>
		/// <c>PSPanel</c> is actively collapsing
		/// </summary>
		Collapsing,

		/// <summary>
		/// <c>PSPanel</c> is in an internal state
		/// </summary>
		/// <remarks>
	...
	/// <summary>
	/// Enumeration of all <c>PSPanel</c> properties that trigger
	/// <see cref="PSPanel.PropertyChange"/> events
	/// </summary>
	/// <remarks>
	/// When a property changes, a <see cref="PSPanelPropertyChangeEventArgs"/> event is
	...
	/// </remarks>
	public enum PSPanelProperties {
		/// <summary>
		/// <see cref="PSPanel.Caption"/>
		/// </summary>
		CaptionProperty,
		/// <summary>
		/// <see cref="PSPanel.CaptionGradient"/>
		/// </summary>
		CaptionGradientProperty,
		/// <summary>
		/// <see cref="PSPanel.CaptionGradientMode"/>
		/// </summary>
		CaptionGradientModeProperty,
		/// <summary>
		/// <see cref="PSPanel.CaptionCornerType"/>
		/// </summary>
		CaptionCornerTypeProperty,
		/// <summary>
		/// <see cref="PSPanel.GradientOffset"/>
		/// </summary>
		GradientOffsetProperty,
		/// <summary>
		/// <see cref="PSPanel.CaptionUnderline"/>
		/// </summary>
		CaptionUnderlineProperty,
		/// <summary>
		/// <see cref="PSPanel.HorzAlignment"/>
		/// </summary>
		HorzAlignmentProperty,
		/// <summary>
		/// <see cref="PSPanel.VertAlignment"/>
		/// </summary>
		VertAlignmentProperty,
		/// <summary>
		/// <see cref="PSPanel.Font"/>
		/// </summary>
		FontProperty,
		/// <summary>
		/// <see cref="PSPanel.TextColors"/>
		/// </summary>
		TextColorsProperty,
		/// <summary>
		/// <see cref="PSPanel.TextHighlightColors"/>
		/// </summary>
		TextHighlightColorsProperty,
		/// <summary>
		/// <see cref="PSPanel.CurveRadius"/>
		/// </summary>
		CurveRadiusProperty,
		/// <summary>
		/// <see cref="PSPanel.ImageItems"/>
		/// </summary>
		ImageItemsProperty,
		/// <summary>
		/// <see cref="PSPanel.ExpandedGlyphs"/>
		/// </summary>
		ExpandedGlyphsProperty,
		/// <summary>
		/// <see cref="PSPanel.CollapsedGlyphs"/>
		/// </summary>
		CollapsedGlyphsProperty,
		/// <summary>
		/// <see cref="PSPanel.Spacing"/>
		/// </summary>
		SpacingProperty,
		/// <summary>
		/// <see cref="PSPanel.FitToImage"/>
		/// </summary>
		FitToImageProperty,
		/// <summary>
		/// <see cref="PSPanel.PanelState"/>
		/// </summary>
		PanelStateProperty,
		/// <summary>
		/// <see cref="PSPanel.IsFixedHeight"/>
		/// </summary>
		IsFixedHeightProperty,
		/// <summary>
		/// <see cref="PSPanel.PanelGradient"/>
		/// </summary>
		PanelGradientProperty,
		/// <summary>
		/// <see cref="PSPanel.PanelGradientMode"/>
		/// </summary>
		PanelGradientModeProperty,
		/// <summary>
		/// <see cref="PSPanel.OutlineColor"/>
		/// </summary>
		...
		EnabledProperty,
		/// <summary>
		/// <see cref="PSPanel.AnimationRate"/>
		/// </summary>
		AnimationRateProperty,
		/// <summary>
		/// <see cref="PSPanel.DisabledOpacity"/>
		/// </summary>
		DisabledOpacityProperty,
		/// <summary>
		/// <see cref="PSPanel.PSPanelStyle"/>
		/// </summary>
		PSPanelStyleProperty,
		/// <summary>
	...
	/// <summary>
	/// Enumeration defining visual style of <c>PSPanel</c>
	/// </summary>
	public enum PSPanelStyle {
		/// <summary>
		/// User defined style
		/// </summary>
		Custom,
	...
	#endregion PSPanel enumerations

	/// <summary>
	/// <c>PSPanel</c> - Collapsible Panel ala Windows XP
	/// </summary>
	/// <remarks>
	/// An <c>PSPanel</c> is a control/container based on <see cref="System.Windows.Forms.Panel"/>.
	/// It can be associated with an <see cref="PSPanelGroup"/> for automatic grouping/management, or
	/// it can be placed directly on a <see cref="System.Windows.Forms.Form"/>
	/// <para>
	/// <c>PSPanel</c> uses a <see cref="TypeConverter"/> to allow designer code generation to use the constructor that
	/// specifies the <see cref="ExpandedHeight"/> property.
	/// </para>
	/// <para>
	/// <c>PSPanel</c> has the following primary properties:
	///	<list type="table">
	///		<listheader>
	///			<term>Property</term>
	...
	///			<description>Text displayed in the caption of the <c>PSPanel</c></description>
	///		</item>
	///		<item>
	...
	///			<description><see cref="StateImageItems"/> describing the <see cref="PSImgSet"/> and index mappings for
	...
	///			<description><see cref="StateImageItems"/> describing the <see cref="PSImgSet"/> and index mappings for
	///			the <c>Normal</c>, <c>Highlight</c>, <c>Pressed</c>, and <c>Disabled</c> images that appear on the
	///			right of the <see cref="Caption"/> when the <see cref="PanelState"/> is <see cref="PSPanelState.Collapsed"/></description>
	///		</item>
	///		<item>
	///			<term><see cref="ExpandedGlyphs"/></term>
	///			<description><see cref="StateImageItems"/> describing the <see cref="PSImgSet"/> and index mappings for
	///			the <c>Normal</c>, <c>Highlight</c>, <c>Pressed</c>, and <c>Disabled</c> images that appear on the
	///			right of the <see cref="Caption"/> when the <see cref="PanelState"/> is <see cref="PSPanelState.Expanded"/></description>
	///		</item>
	///		<item>
	///			<term><see cref="PanelState"/></term>
	///			<description>Current state of the <c>PSPanel</c>. <see cref="PSPanelState.Expanded"/> or <see cref="PSPanelState.Collapsed"/></description>
	///		</item>
	///		<item>
	///			<term><see cref="IsFixedHeight"/></term>
	///			<description><see langword="true"/> if the <c>PSPanel</c> cannot be expanded/collapsed</description>
	///		</item>
	///		<item>
	...
	///		</item>
	///		<item>
	///			<term><see cref="PSPanelStyle"/></term>
	///			<description>Set the style of the <c>PSPanel</c> - <see cref="PSUI.PSPanelStyle.Custom"/> or 
	///			<see cref="PSUI.PSPanelStyle.WindowsXP"/></description>
	///		</item>
	///	</list>
	///	</para>
	///	<para>
	...
	///			<description>Triggered when a primary property changes. See <see cref="PSPanelProperties"/></description>
	///		</item>
	///		<item>
	///			<term><see cref="PanelStateChange"/></term>
	///			<description>Triggered when the <c>PSPanel</c> expands/collapses</description>
	///		</item>
	///	</list>
	///	</para>
	/// </remarks>
	[TypeConverter(typeof(PSUI.Helpers.PSPanelTypeConverter))]
	public class PSPanel : System.Windows.Forms.Panel {
		#region Constants
		/// <summary>
		...
		/// <summary>
		/// Default margins/spacing for the <c>PSPanel</c> caption
		/// </summary>
		...
		/// </summary>
		private static readonly Color DefaultCaptionGradientStart = Color.Gray;

		/// <summary>
		/// Default gradient end <see cref="Color"/> for the <see cref="Caption"/>
		/// </summary>
		private static readonly Color DefaultCaptionGradientEnd = Color.Gray ;
		...
		/// </summary>
		private static readonly Color DefaultPanelGradientStart = Color.White ;

		/// <summary>
		/// Default gradient end <see cref="Color"/> for the panel
		/// </summary>
		private static readonly Color DefaultPanelGradientEnd = Color.White ;
		...
		/// </summary>
		private static readonly ColorPair DefaultTextColors = new ColorPair(DefaultTextColor,Color.White ) ;
		...
		/// <see cref="Caption"/> text
		/// </summary>
		private static readonly ColorPair DefaultTextHighlightColors = new ColorPair(DefaultTextHighlightColor,Color.Black ) ;
		...
		/// </remarks>
		private static readonly Color DefaultCaptionUnderlineColor = Color.Blue ;
		...
		/// that it can be shared by all instances of <c>PSPanel</c>
		/// </remarks>
		...
		/// <see cref="PSUI.PSPanelStyle.WindowsXP"/>
		/// </summary>
			...
			get {
				lock(typeof(PSPanel)) {
					if (xpStyleExpandGlyphs == null) {
						...
						try {
							xpStyleExpandGlyphs.PSImgSet = new PSImgSet(LoadBitmap("PSUI.xp_glyphs.png"),4) ;
			...
			get {
				lock(typeof(PSPanel)) {
					if (xpStyleCollapseGlyphs == null) {
						...
						try {
							xpStyleCollapseGlyphs.PSImgSet = new PSImgSet(LoadBitmap("PSUI.xp_glyphs.png"),4) ;
		...
		/// <summary>
		/// Used to load bitmap resources from the <c>PSPanel</c> assembly
		/// </summary>
		...
		private static Bitmap LoadBitmap(String resource) {
			System.Reflection.Assembly psPanel = System.Reflection.Assembly.GetAssembly(typeof(PSPanel));			
			return new Bitmap(psPanel.GetManifestResourceStream(resource));
		}
		...
		/// <summary>
		/// Tracks the current <see cref="PSPanelState"/>of the panel
		/// </summary>
		/// <remarks>
		/// See <see cref="PanelState"/>
		/// </remarks>
		private PSPanelState panelState = PSPanelState.Expanded ;

		/// <summary>
		/// The text for the <see cref="Caption"/> of the PSPanel
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Curve Radius for PSPanel Caption
		/// </summary>
		/// <remarks>
		...
		/// left-side of the caption of the <c>PSPanel</c>
		/// </remarks>
		...
		/// (normal,highlight,pressed,disabled) when <see cref="PSPanelState.Expanded"/>
		/// </summary>
		/// <remarks>
		/// Glyphs specify the images that appear on the right-side of the <c>PSPanel</c>
		/// caption
		...
		/// <summary>
		/// Defines the image index mappings for each glyph image state
		/// (normal,highlight,pressed,disabled) when <see cref="PSPanelState.Collapsed"/>
		/// </summary>
		/// <remarks>
		/// Glyphs specify the images that appear on the right-side of the <c>PSPanel</c>
		/// caption
		...
		/// <summary>
		/// Changes the transparency of an <c>PSPanel</c> when in the disabled state
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Style of the PSPanel
		/// </summary>
		/// <remarks>
		/// Default is custom
		/// </remarks>
		private PSPanelStyle psPanelStyle = PSPanelStyle.Custom ;
		...
		/// <summary>
		/// <see cref="Font"/> used to draw caption text when <c>PSPanel</c> is disabled
		/// </summary>
		private Font disabledFont = null ;

		/// <summary>
		/// <see cref="LinearGradientBrush"/> for the full caption area of <c>PSPanel</c> 
		/// </summary>
		private LinearGradientBrush captionBrush = null ;

		/// <summary>
		/// Cached <see cref="GraphicsPath"/> for the full caption area of <c>PSPanel</c> 
		/// </summary>
		...
		/// cached layout of the <c>PSPanel</c>
		/// </summary>
		...
		/// </summary>
		/// <remarks>
		/// <c>PSPanel</c> uses a <see cref="TypeConverter"/> to pass this value to the <c>PSPanel</c> 
		...
		/// <summary>
		/// The <see cref="Rectangle"/> describing the entire caption area of the <c>PSPanel</c>
		/// </summary>
		...
		/// </summary>
		private Rectangle psPanelRect = new Rectangle(0,0,0,0);
		...
		/// <summary>
		/// Current <see cref="PSPanelDrawState"/>
		/// </summary>
		private PSPanelDrawState panelDrawState = PSPanelDrawState.Normal ;
			#endregion Dynamic State Fields
		#endregion Fields

		#region Constructor(s)
		/// <summary>
		/// Construct an <c>PSPanel</c> with the specified <see cref="ExpandedHeight"/>
		/// </summary>
		/// <param name="expandedHeight"></param>
		public PSPanel(int expandedHeight) {
		...
		/// <summary>
		/// Construct an <c>PSPanel</c> with a default <see cref="ExpandedHeight"/> of 100 pixels
		/// </summary>
		public PSPanel() : this(280) {}
		...
		public LinearGradientMode CaptionGradientMode {
			...
			set {
				if (captionGradientMode != value) {
					...
					OnPropertyChange(PSPanelProperties.CaptionGradientModeProperty) ;
				}
			}
		}
		...
		public CornerType CaptionCornerType {
			...
			set {
				if (captionCornerType != value) {
					...
					OnPropertyChange(PSPanelProperties.CaptionCornerTypeProperty) ;
				}
			}
		}
		...
		public LinearGradientMode PanelGradientMode {
			...
			set {
				if (panelGradientMode != value) {
					...
					OnPropertyChange(PSPanelProperties.PanelGradientModeProperty) ;
				}
			}
		}

		/// <summary>
		/// Get/Set the style for the PSPanel
		/// </summary>
		/// <remarks>
		/// <see cref="PSUI.PSPanelStyle.Custom"/> uses all user-defined settings, while 
		/// <see cref="PSUI.PSPanelStyle.WindowsXP"/> provides overrides to certain properties
		/// to provide a <c>WindowsXP</c> look and feel.
		/// <para>
		/// Currently, <see cref="PSUI.PSPanelStyle.WindowsXP"/>, overrides user-specified values
		/// for <see cref="ExpandedGlyphs"/> and <see cref="CollapsedGlyphs"/>
		/// </para>
		/// </remarks>
		[Category("Behavior"),
		Description("PSPanel Style"),
		DefaultValue(typeof(PSPanelStyle),"Custom")]
		public PSPanelStyle PSPanelStyle {
			get {
				return psPanelStyle ;
			}

			set {
				if (psPanelStyle != value) {
					psPanelStyle = value ;
					OnPropertyChange(PSPanelProperties.PSPanelStyleProperty) ;
				}
			}
		}
		...
		/// <para>Set to zero (0) for no animation</para>
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.AnimationRateProperty"/> argument</para>
		/// </remarks>
		[Category("Behavior"),
		...
		public int AnimationRate {
			...
			set {
				if (animationRate != value) {
					animationRate = value ;
					OnPropertyChange(PSPanelProperties.AnimationRateProperty) ;
				}
			}
		}

		/// <summary>
		/// Get/Set the transparency of the <c>PSPanel</c> when disabled
		/// </summary>
		/// <remarks>
		/// The default value is 255 (no transparency). Decrease towards zero to
		/// cause transparency effect
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.DisabledOpacityProperty"/> argument</para>
		/// </remarks>
		[Category("Behavior"),
		Description("Level of transparency when PSPanel is disabled"),
		...
		public byte DisabledOpacity {
			...
			set {
				if (disabledOpacity != value) {
					...
					OnPropertyChange(PSPanelProperties.DisabledOpacityProperty) ;
				}
			}
		}
		...
		/// </summary>
		/// <remarks>
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.PanelStateProperty"/> argument</para>
		/// <para>Fires a PanelStateChange event w/ <see cref="System.EventArgs.Empty"/> arguments</para>
		/// </remarks>
		[Category("Behavior"),
		Description("The state of the PSPanel"),
		DefaultValue(PSPanelState.Expanded)]
		public PSPanelState PanelState {
			get {
				return panelState ;
			}
			...
			set {
				if (panelState != value) {
					if (value == PSPanelState.Collapsed) {
						...
						PanelDrawState = PSPanelDrawState.Internal ;
						SetHeight(xpCaptionRect.Top + xpCaptionRect.Height) ;
						PanelDrawState = PSPanelDrawState.Normal ;
						panelState = value ;
					} else {
						panelDrawState = PSPanelDrawState.Expanding; 
						panelState = value ;
					...
					OnPanelStateChange() ;
					OnPropertyChange(PSPanelProperties.PanelStateProperty) ;

					if (panelState == PSPanelState.Expanded)
						OnPanelExpanded() ;
					else 
						OnPanelCollapsed() ;
				}
		...
		/// </summary>
		/// <remarks>
		/// Glyph images are <b>not</b> drawn when the <c>PSPanel</c> is fixed
		/// <para>The default value for this property is <see langword="false"/></para>
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.IsFixedHeightProperty"/> argument</para>
		/// </remarks>
		[Category("Behavior"),
		...
		public bool IsFixedHeight {
			...
			set {
				if (isFixedHeight != value) {
					isFixedHeight = value ;
					OnPropertyChange(PSPanelProperties.IsFixedHeightProperty) ;
				}
			}
		}
		
		/// <summary>
		/// The caption text for the <c>PSPanel</c>
		/// </summary>
		/// <remarks>
		...
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.CaptionProperty"/> argument</para>
		/// </remarks>
		[Category("Caption"),
		Description("The text displayed in the caption of the PSPanel"),DefaultValue("")]
		public String Caption {
			...
			set {
				if (value != text) {
					...
					OnPropertyChange(PSPanelProperties.CaptionProperty) ;
				}
			}
		}
		...
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.FontProperty"/> argument</para>
		/// </remarks>
		[Category("Caption"),
		Description("The font for the caption of the PSPanel"),DefaultValue("")]
		public override Font Font {
			...
			set {
				if (font != value) {
					...
					font = value ;
					OnPropertyChange(PSPanelProperties.FontProperty) ;
				}
			}
		}
		...
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.TextColorsProperty"/> argument</para>
		/// </remarks>
		[Category("Caption"),Description("The normal fore/background colors of the PSPanel caption text")]
		...
		public ColorPair TextColors {
			...
			set {
				if (textColors != value) {
					textColors = value ;
					OnPropertyChange(PSPanelProperties.TextColorsProperty) ;
				}
			}
		}
		...
		/// Currently, the background color value is ignored (i.e., never used) and always
		/// <see cref="Color.Empty"/>
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.TextHighlightColorsProperty"/> argument</para>
		/// </remarks>
		[Category("Caption"),Description("The highlight colors (fore/back) of the PSPanel Caption text when highlighted")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		public ColorPair TextHighlightColors {
			...
			set {
				if (textHighlightColors != value) {
					...
					OnPropertyChange(PSPanelProperties.TextHighlightColorsProperty) ;
				}
			}
		}
		...
		/// </summary>
		/// <remarks>
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.CaptionGradientProperty"/> argument</para>
		/// </remarks>
		[Category("Caption"),Description("The gradient colors for the caption of the PSPanel")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		public GradientColor CaptionGradient {
			...
			set {
				if (captionGradient != value) {
					...
					OnPropertyChange(PSPanelProperties.CaptionGradientProperty) ;
				}
			}
		}
		...
		/// <remarks>
		/// Set to <see cref="Color.Empty"/> for no underline
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.CaptionUnderlineProperty"/> argument</para>
		/// </remarks>
		[Category("Caption"),
		Description("Color for underlining the caption of the PSPanel")]
		public Color CaptionUnderline {
			...
			set {
				if (captionUnderline != value) {
					...
					OnPropertyChange(PSPanelProperties.CaptionUnderlineProperty) ;
				}
			}
		}
		...
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.HorzAlignmentProperty"/> argument</para>
		/// </remarks>
		[Category("Caption"),
		Description("The horizontal alignment of the PSPanel caption text"),
		DefaultValue("Near")]
		public StringAlignment HorzAlignment {
			...
			set {
				if (horzAlignment != value) {
					horzAlignment = value ;
					OnPropertyChange(PSPanelProperties.HorzAlignmentProperty) ;
				}
			}
		}
		...
		/// left-to-right semnatics
		/// <para>Default value is <see cref="StringAlignment.Near"/></para>
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.VertAlignmentProperty"/> argument</para>
		/// </remarks>
		[Category("Caption"),
		Description("The vertial alignment of the PSPanel caption text"),
		DefaultValue("Near")]
		public StringAlignment VertAlignment {
			...
			set {
				if (vertAlignment != value) {
					vertAlignment = value ;
					OnPropertyChange(PSPanelProperties.VertAlignmentProperty) ;
				}
			}
		}
		...
		/// </summary>
		/// <remarks>
		/// <see cref="StateImageItems"/> which encapsulates an <see cref="PSImgSet"/> and
		...
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.ImageItemsProperty"/> argument</para>
		/// </remarks>
		/// 
		[Category("Caption"),
		...
		public StateImageItems ImageItems {
			...
			set {
				if (imageItems != value) {
					imageItems = value ;
					OnPropertyChange(PSPanelProperties.ImageItemsProperty) ;
				}
			}
		}
		...
		protected bool ShouldSerializeImageStates() {
			return !imageItems.IsEmpty || (imageItems.PSImgSet != null);
		}
		...
		/// <c>PSPanel</c> is <see cref="PSPanelState.Expanded"/>
		/// </summary>
		/// <remarks>
		/// <see cref="StateImageItems"/> which encapsulates an <see cref="PSImgSet"/> and
		/// image mappings for the states <c>Normal</c>, <c>Highlight</c>, <c>Pressed</c>, and
		...
		/// set to <see cref="DesignerSerializationVisibility.Content"/> for proper code generation
		/// in InitializeComponent()</para>
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.ExpandedGlyphsProperty"/> argument</para>
		/// </remarks>
		/// 
		[Category("Caption"),
		Description("Glyph state image map when the PSPanel is Expanded")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		public StateImageItems ExpandedGlyphs {
			...
			set {
				if (glyphImageItemsExpanded != value) {
					...
					OnPropertyChange(PSPanelProperties.ExpandedGlyphsProperty) ;
				}
			}
		}
		...
		protected bool ShouldSerializeExpandedGlyphs() {
			return (!glyphImageItemsExpanded.IsEmpty || (glyphImageItemsExpanded.PSImgSet != null)) ;
		}
		...
		/// <summary>
		/// Describes images that appear on the right side of the caption when the
		/// <c>PSPanel</c> is <see cref="PSPanelState.Collapsed"/>
		/// </summary>
		/// <remarks>
		/// <see cref="StateImageItems"/> which encapsulates an <see cref="PSImgSet"/> and
		/// image mappings for the states <c>Normal</c>, <c>Highlight</c>, <c>Pressed</c>, and
		...
		/// set to <see cref="DesignerSerializationVisibility.Content"/> for proper code generation
		/// in InitializeComponent()</para>
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.CollapsedGlyphsProperty"/> argument</para>
		/// </remarks>
		/// 
		[Category("Caption"),
		Description("Glyph state image map when the PSPanel is Collapsed")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		public StateImageItems CollapsedGlyphs {
			...
			set {
				if (glyphImageItemsCollapsed != value) {
					...
					OnPropertyChange(PSPanelProperties.CollapsedGlyphsProperty) ;
				}
			}
		}
		...
		protected bool ShouldSerializeCollapsedGlyphs() {
			return (!glyphImageItemsCollapsed.IsEmpty || (imageItems.PSImgSet != null)) ;
		}
	...
	protected void ResetCollapsedGlyphs() {
		...
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.CurveRadiusProperty"/> argument</para>
		/// </remarks>
		[Category("Caption"),
		Description("Curve radius for the caption of the PSPanel"),
		DefaultValue(7)]
		public int CurveRadius {
			...
			set {
				if (captionCurveRadius != value) {
					...
					OnPropertyChange(PSPanelProperties.CurveRadiusProperty) ;
				}
			}
		}
		...
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.GradientOffsetProperty"/> argument</para>
		/// </remarks>
		[Category("Caption"),
		Description("Gradient offset (start of gradient) for caption of the PSPanel"),
		DefaultValue(0.5d)]
		public double GradientOffset {
			...
			set {
				if (gradientOffset != value) {
					...
					OnPropertyChange(PSPanelProperties.GradientOffsetProperty) ;
				}
			}
		}
		...
		/// </summary>
		/// <remarks>
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.PanelGradientProperty"/> argument</para>
		/// </remarks>
		[Category("Panel"),Description("The gradient colors for the panel of the PSPanel")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		public GradientColor PanelGradient {
			...
			set {
				if (panelGradient != value) {
					panelGradient = value ;
					OnPropertyChange(PSPanelProperties.PanelGradientProperty) ;
				}
			}
		}
		...
		/// <remarks>
		/// Set to <see cref="Color.Empty"/> for no panel outline
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.PanelOutlineColorProperty"/> argument</para>
		/// </remarks>
		[Category("Panel"),
		Description("The color of the outline for the panel of the PSPanel")]
		public Color OutlineColor {
			...
			set {
				if (panelOutlineColor != value) {
					...
					OnPropertyChange(PSPanelProperties.PanelOutlineColorProperty) ;
				}
			}
		}
		...
		/// <summary>
		/// The <see cref="Control.Height"/> of the <c>PSPanel</c> when expanded
		/// </summary>
		/// <remarks>
		...
		/// the <c>PSPanel</c> uses a <see cref="TypeConverter"/> to create
		...
		/// not resize (at all!)
		/// <para>
		/// If the layout of the <c>PSPanel</c> is not up-to-date it is updated
		/// </para>
		/// <para>
		/// If the <c>PSPanel</c> is not animating, and currently expanded the height is adjusted
		...
		/// of <see cref="PSPanelProperties.PanelHeightProperty"/>
		/// </para>
		/// </remarks>
		...
		public int PanelHeight {
			...
			set {
				if (panelHeight != value) {
					...
					OnPropertyChange(PSPanelProperties.PanelHeightProperty) ;
				}
			}
		}
		...
		/// </summary>
		/// <remarks>If the Layout of the <c>PSPanel</c> is not upto date, it is updated</remarks>
		[Browsable(false)]
		...
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.SpacingProperty"/> argument</para>
		/// </remarks>
		public Point Spacing {
			...
			set {
				if (spacing != value) {
					spacing = value ;
					OnPropertyChange(PSPanelProperties.SpacingProperty) ;
				}
			}
		}
		...
		/// </para>
		/// <para>Fires a PropertyChange event w/ <see cref="PSPanelProperties.FitToImageProperty"/> argument</para>
		/// </remarks>
		...
		public bool FitToImage {
			...
			set {
				if (isFitToImage != value) {
					isFitToImage = value ;
					OnPropertyChange(PSPanelProperties.FitToImageProperty) ;
				}
			}
		}
		...
		/// <summary>
		/// <see cref="Font"/> used to draw the <see cref="Caption"/> when the <c>PSPanel</c> is disabled
		/// </summary>
		/// <remarks>
		...
		public bool IsActive {
			get {
				return PanelDrawState != PSPanelDrawState.Normal ;
			}
		}
		...
		public bool IsExpanding {
			get {
				return PanelDrawState == PSPanelDrawState.Expanding ;
			}
		}
		...
		public bool IsCollapsing {
			get {
				return PanelDrawState == PSPanelDrawState.Collapsing ;
			}
		}

		/// <summary>
		/// <see true="true"/> if <see cref="PSPanelState.Expanded"/>
		/// </summary>
		[Browsable(false)]
		public bool IsExpanded {
			get {
				return panelState == PSPanelState.Expanded ;
			}
		}

		/// <summary>
		/// <see true="true"/> if <see cref="PSPanelState.Collapsed"/>
		/// </summary>
		[Browsable(false)]
		public bool IsCollapsed {
			get {
				return panelState == PSPanelState.Collapsed ;
			}
		}
		...
		#region Methods
		/// <summary>
		/// Routine to toggle the state of <c>PSPanel</c> from Expanded to Collapsed
		/// (or visa-versa)
		/// </summary>
		/// <remarks>
		/// This routine provides a way to trigger the visual animation of
		/// expanding/collapsing a <c>PSPanel</c>
		/// </remarks>
		public virtual void TogglePanelState() {
			// If we are animating, start it now...
			if (animationRate != 0) {
				if (IsExpanded) {
					PanelDrawState = PSPanelDrawState.Collapsing ;
				} else {
					PanelDrawState = PSPanelDrawState.Expanding ;
				}
				...
				if (IsExpanded) {
					PanelDrawState = PSPanelDrawState.Internal ;
					PanelState = PSPanelState.Collapsed ;
				} else {
					PanelDrawState = PSPanelDrawState.Internal ;
		...
		private StateImageItems GetGlyphStateImageItems() {
			if (PSPanelStyle == PSPanelStyle.WindowsXP) {
				if (IsActive) {
		...
		/// <summary>
		/// Select the appropriate <see cref="PSImgSet"/> based on the current
		/// state of the <c>PSPanel</c>
		/// </summary>
		/// <returns>
		/// The <see cref="PSImgSet"/> containing the appropriate glyph images
		/// </returns>
		private PSImgSet GetGlyphImages() {
			return GetGlyphStateImageItems().PSImgSet ;
		}		


		private PSPanelDrawState PanelDrawState {
			get {
			...
			set {
				if (panelDrawState != value) {
					...
					if (panelDrawState == PSPanelDrawState.Collapsing) {
						OnPanelCollapsing() ;
					} else if (panelDrawState == PSPanelDrawState.Expanding) {
						OnPanelExpanding() ;
					}
				}
			}
		...
		if (ImageItems.PSImgSet != null) {
				imageRect = new Rectangle(0,0,Math.Min(ImageItems.PSImgSet.Size.Width,64),Math.Min(ImageItems.PSImgSet.Size.Height,64)) ;
				// 1 unit of margin (border to image)
				totalXSpacing += Spacing.X ;
			}

		PSImgSet glyphImages = GetGlyphImages() ;
			...
			if (ImageItems.PSImgSet != null) {
				if (ImageItems.PSImgSet.Size.Height > xpCaptionRect.Height) {
			...
			if (OutlineColor != Color.Empty) {
				psPanelRect.Inflate(-1,0) ;
				psPanelRect.Height -= 1 ;
			}
...
#if DEBUG_DRAWING
			System.Diagnostics.Debug.WriteLine("--- PSPanel "+Caption+" ---") ;
			...
			System.Diagnostics.Debug.WriteLine("("+Name+")"+"Panel Rect="+psPanelRect) ;
#endif
		}
		...
		/// <summary>
		/// Draw the caption area of the <c>PSPanel</c>
		/// </summary>
		...
		/// <summary>
		/// Paint the panel portion of the <c>PSPanel</c>
		/// </summary>
		...
		protected void DrawPanel(Graphics graphics) {
			...
			if (psPanelRect.Height > 1) {
				// Draw the panel outline if necessary. Note that psPanelRect has
				...
				using(Pen pen = new Pen(Color.White)) {
					graphics.DrawRectangle(pen,psPanelRect) ;
				}
#else
				if (!PanelGradient.IsTransparent) {
					// fill the panel with the gradient
					graphics.FillRectangle(PanelBrush,psPanelRect) ;
				}
#endif
			}
		}
		...
		protected override void SetBoundsCore(int x, int y, int width, int height,BoundsSpecified specified) {
			if ((specified & BoundsSpecified.Height) != 0) {
				...
				if ((panelState == PSPanelState.Collapsed) && (PanelDrawState == PSPanelDrawState.Normal))
					return ;
			}
		...
		/// </summary>
		/// <remarks>
		/// If the <c>PSPanel</c> <see cref="IsFixedHeight"/> property is
		...
		protected override void OnMouseMove(MouseEventArgs e) {
			...
			// is it a caption hit?
			if ((e.Y < psPanelRect.Top) && !IsFixedHeight) {
				// we are going hot
				if (!isCaptionHot) {
		...
		protected override void OnMouseDown(MouseEventArgs e) {
		   base.OnMouseDown(e);
			...
			if ((e.Y >= psPanelRect.Top) || this.IsActive || IsFixedHeight || (e.Button != MouseButtons.Left)) {
				return ; 
			}			
		...
		private void animationTimer_Tick(object sender, System.EventArgs e) {
			...
			switch (PanelDrawState) {
				case PSPanelDrawState.Expanding:
				...
				case PSPanelDrawState.Collapsing:
					// still something to collapse
					if ((Height - animationHeightAdjustment) > psPanelRect.Top) {
						Height -= animationHeightAdjustment ;
			...
			// set the opacity for all the controls on the PSPanel
			...
			// hide/show controls based on the height of the PSPanel (as it shrinks/grows)
			SetControlsVisible();
		...
		/// <summary>
		/// Changes the visibility of controls based upon the height of the PSPanel
		/// </summary>
		/// <remarks>
		...
		private void SetControlsVisible() {
			foreach (Control c in animationVisibility.Keys) {
				if (((bool)animationVisibility[c]) == true) {
					c.Visible = (c.Bottom >= psPanelRect.Top) ;
				}
			}
		}

		/// <summary>
		/// Changes the transparency of controls based upon the height of the PSPanel
		/// </summary>
		/// <remarks>
		/// Only used during animation
		/// </remarks>
	...
	#region class PSPanelPropertyChangeEventArgs (and related)
	/// <summary>
	/// Delegate signature for <see cref="PSPanel.PropertyChange"/> events
	/// </summary>
	public delegate void PanelPropertyChangeHandler(PSPanel psPanel,PSPanelPropertyChangeEventArgs e) ;

	/// <summary>
	/// EventArgs for <see cref="PSPanel.PropertyChange"/> events
	/// </summary>
	public class PSPanelPropertyChangeEventArgs : System.EventArgs {
		/// <summary>
		/// The property that changed
		/// </summary>
		private readonly PSPanelProperties psPanelProperty ;
		...
		/// </summary>
		public PSPanelProperties PSPanelProperty {
			get {
				return this.psPanelProperty ;
			}
		}
	}
	#endregion class PSPanelPropertyChangeEventArgs
}
