...
namespace PSUI {
	/// <summary>
	/// PSImgPanel Control displays a set of source images allowing the
	/// user to select an image using the mouse or keyboard
	/// </summary>
	/// <remarks>
	/// The <c>PSImgPanel</c> can be run in two different modes:
	/// <list type="bullet">
	...
	/// cause the <c>PSImgPanel</c> to be hidden
	/// </para>
	/// <para>
	/// <c>PSImgPanel</c> has the following primary properties:
	///	<list type="table">
	///		<listheader>
	///			<term>Property</term>
	...
	///	</para>
	///	<para>
	///	<c>PSImgPanel</c> has the following primary events:
	///	<list type="table">
	///		<listheader>
	///			<term>Event</term>
	///			<description>Purpose</description>
	...
	///	</para>
	///	<para>
	///	<c>PSImgPanel</c> has the following primary methods:
	///	<list type="table">
	///		<listheader>
	///			<term>Method</term>
	///			<description>Purpose</description>
	...
	///	</para>
	/// </remarks>
	public class PSImgPanel : ScrollableControl {
		#region PSImgPanel enums
		/// <summary>
		/// Enumeration providing hint on how <see cref="PSImgPanel"/> layout
		/// should appear
		/// </summary>
		public enum PanelSizeHints {
			...
			/// </summary>
			/// <remarks>
			/// <c>PSImgPanel</c> will be vertically oriented
			/// </remarks>
			MinimizeColumns=0,
			/// <summary>
			...
			/// </summary>
			/// <remarks>
			/// <c>PSImgPanel</c> will be horizontally oriented
			/// </remarks>
			MinimizeRows=2,
			...
			/// </summary>
			/// <remarks>
			/// <c>PSImgPanel</c> will be a square
			/// </remarks>
			MinimizeBoth
		}
		...
		/// <summary>
		/// Enumeration of property arguments for <see cref="PSImgPanel.PropertyChange"/>
		/// </summary>
		public enum ImagePanelProperties {
			/// <summary>
			/// <see cref="PSImgPanel.OnBackColorChanged"/>
			/// </summary>
			BackColorProperty,

			/// <summary>
			/// <see cref="PSImgPanel.PanelGridSize"/>
			/// </summary>
			PanelGridSizeProperty,

			/// <summary>
			/// <see cref="PSImgPanel.GridColor"/>
			/// </summary>
			GridColorProperty,

			/// <summary>
			/// <see cref="PSImgPanel.SelectedColor"/>
			/// </summary>
			SelectedColorsProperty,

			/// <summary>
			/// <see cref="PSImgPanel.SetImages(Bitmap,int)"/>
			/// </summary>
			ImagesProperty,

			/// <summary>
			/// <see cref="PSImgPanel.AutoSelect"/>
			/// </summary>
			AutoSelectProperty,

			/// <summary>
			/// <see cref="PSImgPanel.Dimensions"/>
			/// </summary>
			DimensionsProperty,

			/// <summary>
			/// <see cref="PSImgPanel.DefaultImage"/>
			/// </summary>
		...
		/// <summary>
		/// Create an empty <c>PSImgPanel</c>
		/// </summary>
		public PSImgPanel() {
			//
		...
		/// <summary>
		/// Create an <c>PSImgPanel</c> with the specified sourc image
		/// and grid dimensions
		/// </summary>
		...
		public PSImgPanel(Bitmap sourceImages,int imageCount,int rows,int columns) {
			//
			// Required for Windows.Forms Class Composition Designer support
			//
			InitializeComponent();
		...
		/// <summary>
		/// Get/Set the line thickness of the <c>PSImgPanel</c> grid
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Get/Set the dimensions of the <c>PSImgPanel</c> grid
		/// </summary>
		/// <remarks>
		/// The PSImgPanel grid is define in terms of rows/columns where 
		...
		#region Methods
		/// <summary>
		/// Set the source images for the <c>PSImgPanel</c>
		/// </summary>
		...
		/// <summary>
		/// Show the <c>PSImgPanel</c> as a popup using the specified
		...
		/// <summary>
		/// Get the number of rows in the <c>PSImgPanel</c>
		/// </summary>
		private int Rows {
			get {
		...
		/// <summary>
		/// Get the number of columns in the <c>PSImgPanel</c>
		/// </summary>
		private int Columns {
			get {
		...
		/// <summary>
		/// Get the cached <c>PSImgPanel</c> <see cref="Bitmap"/>, creating
		/// it if necessary
		/// </summary>
		...
		/// <summary>
		/// Determine if the <c>PSImgPanel</c> has a selected image
		/// </summary>
		...
		protected virtual void OnImageSelectedEvent(int imageIndex) {
			if (imageSelectedListeners != null) {
				imageSelectedListeners(this,new PSImgEventArgs(imageIndex)) ;
			}
		...
		/// <summary>
		/// Given a rectangle, calculate the best dimensions for the <c>PSImgPanel</c>
		/// </summary>
		...
		/// <returns>
		/// The <see cref="Bitmap"/> representation of the <c>PSImgPanel</c>
		/// </returns>
		...
		/// <summary>
		/// Reset the <c>PSImgPanel</c> in preperation for Popup
		/// </summary>
		...
		/// <summary>
		/// Handle various conditions when the <c>PSImgPanel</c>
		/// is shown/hidden
		/// </summary>
	...
	#region class PSImgEventArgs
	
	public class PSImgEventArgs : System.EventArgs {
	
		private readonly int imageIndex ;
				public PSImgEventArgs(int imageIndex) {
	...
	#endregion class PSImgEventArgs
}
