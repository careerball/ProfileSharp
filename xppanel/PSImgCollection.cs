...
namespace PSUI {
	/// <summary>
	/// <c>PSImgCollection</c> provides a collection of <see cref="Image"/> items with
	...
	/// images are resized.
	/// <para>
	/// <c>PSImgCollection</c> supports the <see cref="TransparentColor"/> property to
	...
	/// </para>
	/// <para>
	/// For this version of <c>PSImgCollection</c> the pixel format is fixed
...
#endif
	[Serializable]
	public class PSImgCollection : ICollection, IList {
		#region Fields
		/// <summary>
		...
		/// <summary>
		/// Explicit operator (requires cast) to convert an <c>PSImgCollection</c>
		/// to a <see cref="System.Windows.Forms.ImageList"/>
		/// </summary>
		/// <param name="imageCollection">The <c>PSImgCollection</c> to convert</param>
		/// <returns>
		/// An <see cref="System.Windows.Forms.ImageList"/> representation of the
		/// <c>PSImgCollection</c>
		/// </returns>
		public static explicit operator ImageList(PSImgCollection imageCollection) {
		...
		/// <summary>
		/// Create an empty <c>PSImgCollection</c>
		/// </summary>
		public PSImgCollection() {}

		/// <summary>
		/// Create an empty <c>PSImgCollection</c> with the specified
		/// canonical image size
		/// </summary>
		/// <param name="size">Canonical size for images</param>
		public PSImgCollection(Size size) {
			imageSize = size ;
		}

		/// <summary>
		/// Create an empty <c>PSImgCollection</c> with the 
		/// specified <see cref="Color"/> value as a transparency
		/// mask
		/// </summary>
		/// <param name="transparentColor">Transparent color mask value</param>
		public PSImgCollection(Color transparentColor) {
		...
		/// <param name="size">Canonical size for images</param>
		/// <param name="transparentColor">Transparent color mask value</param>
		public PSImgCollection(Size size,Color transparentColor) {
			imageSize = size ;
			transparentColor = transparentColor ;
		}

		/// <summary>
		/// Create an <c>PSImgCollection</c> from a 'strip' of bitmap
		/// images
		/// </summary>
		/// <param name="images">The images for the <c>PSImgCollection</c></param>
		/// <param name="imageCount">The number of images in the strip</param>
		public PSImgCollection(Bitmap images,int imageCount) : this(images,imageCount,Color.Empty) {}
		...
		/// </remarks>
		public PSImgCollection(Bitmap images,int imageCount,Color transparentColor) {
			if ((images == null) && (imageCount !=0)) {
				throw new ArgumentException("PSImgCollection(Bitmap,int): Image count must be 0 when bitmap is null") ;
			}

			if (images != null) {
				if ((images.Width % imageCount) != 0) {
					throw new ArgumentException("PSImgCollection(Bitmap,int): Bitmap width is not even multiple of imageCount") ;
				}
		...
		/// <summary>
		/// Get/Set the canonical image size for images in the <c>PSImgCollection</c>
		/// </summary>
		/// <remarks>
		...
		///  as defined by the <c>PSImgCollection</c>
		/// </summary>
		/// <param name="image">The image</param>
		/// <returns>
		/// An <see cref="Image"/> that conforms to the canonical size and
		/// transparent color mask for the <c>PSImgCollection</c>
		/// </returns>
		...
		#region Methods
		/// <summary>
		/// Add an Icon to the <c>PSImgCollection</c>
		/// </summary>
		...
		/// <summary>
		/// Add an <see cref="Image"/> to the <c>PSImgCollection</c>
		/// </summary>
		/// <param name="image">The <see cref="Image"/> to add</param>
		/// <returns>
		/// The index where the <see cref="Image"/> was added to the
		...
		/// <summary>
		/// Add an array of <see cref="Image"/> items to the <c>PSImgCollection</c>
		/// </summary>
		...
		/// <summary>
		/// Determine if the <c>PSImgCollection</c> is synchronized
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Get the number of <see cref="Image"/> items in the <c>PSImgCollection</c>
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Copy the members of the <c>PSImgCollection</c> to the specified
		...
		/// <summary>
		/// Get the synhronization root of the <c>PSImgCollection</c>
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Get an <see cref="IEnumerator"/> for the items in the <c>PSImgCollection</c>
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Determine if the <c>PSImgCollection</c> is read-only
		/// </summary>
		[Browsable(false)]
		...
		/// the <c>PSImgCollection</c>
		/// </summary>
		/// <remarks>
		/// Called by any code that casts the <c>PSImgCollection</c> to
		...
		/// <summary>
		/// Remove the specified value from the <c>PSImgCollection</c>
		/// </summary>
		...
		/// <summary>
		/// Determine if the <c>PSImgCollection</c> contains
		/// the specified value
		/// </summary>
		/// <param name="value">A value to search for</param>
		/// <returns>
		/// <see langword="true"/> if the <c>PSImgCollection</c> contains
		...
		/// <summary>
		/// Clear all images from the <c>PSImgCollection</c>
		/// </summary>
		/// <remarks>
		...
		/// a membe of the <c>PSImgCollection</c>
		/// </returns>
		/// <remarks>
		...
		/// <summary>
		/// Add a value to the <c>PSImgCollection</c>
		/// </summary>
		...
		/// <summary>
		/// Determine if the <c>PSImgCollection</c> is a fixed size
		/// </summary>
		/// <remarks>
