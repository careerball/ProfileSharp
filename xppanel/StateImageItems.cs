...
#endif
	[Serializable]
	public class StateImageItems : PSImgItemCollection {
		...
		/// images in the <see cref="PSImgSet"/> See <see cref="PSUI.Helpers.PSImgMapEditor"/>
		/// </remarks>
		/// 
#if DEBUG
		[Editor(typeof(PSUI.Helpers.PSImgMapEditor),typeof(System.Drawing.Design.UITypeEditor))]
